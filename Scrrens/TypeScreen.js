      ...
      <View style={{marginTop: 90, marginHorizontal: 20}}>
        ...
        <View style={{marginTop: 30, flexDirection: 'column', gap: 12}}>
          <View
            ...
            <Text style={{fontWeight: '500',color:'blue', fontSize: 15}}>Straight</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500',color:'blue', fontSize: 15}}>Gay</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500',color:'blue', fontSize: 15}}>Lesbian</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', color:'blue',fontSize: 15}}>Bisexual</Text>
