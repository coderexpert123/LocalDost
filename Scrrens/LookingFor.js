      ...
      <View style={{marginTop: 90, marginHorizontal: 20}}>
        ...
        <View style={{marginTop: 30, flexDirection: 'column', gap: 12}}>
          <View
            ...
            <Text style={{fontWeight: '500',color:'blue', fontSize: 15}}>Life Partner</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500',color:'blue', fontSize: 15}}>Long-term relationship</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500', color:'blue',fontSize: 15}}>Long-term relationship open to short</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500',color:'blue', fontSize: 15}}>Short-term relationship open to long</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500',color:'blue', fontSize: 15}}>Short-term relationship</Text>
          ...
          <View
            ...
            <Text style={{fontWeight: '500',color:'blue', fontSize: 15}}>Figuring out my dating goals</Text>
